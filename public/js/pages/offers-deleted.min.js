	...
	methods: {
		...
		fetchProducts: function fetchProducts() {
			...
			.then(function (response) {
				_this.offers = response.data.data.data;
				...
				_this.offers.forEach(function (item, i, arr) {
					// console.log(this.checkedOffers);
					// console.log(item.id);
					// console.log(this.checkedOffers.indexOf(item.id) == 0);
					if (_this.checkedOffers.indexOf(item.id) !== -1) {
						item.check = 1;
					}
				});
		...
		deleteOffer: function deleteOffer(offer_id) {
			modal({
		...
		restoreOffer: function restoreOffer(offer_id) {
			modal({
		...
		updateCheckedOffers: function updateCheckedOffers(offer) {
			if (!offer.system) {

				var index = this.checkedOffers.indexOf(offer.id);
		...
		restoreOffers: function restoreOffers() {
			var _this2 = this;
			...
			modal({
				...
				'cancelTitle': 'Отмена',
				'type': 'modal-default',
				'onOk': function onOk($modal) {
					window.axios.post('/offers/restore', _this2.checkedOffers).then(function (response) {
