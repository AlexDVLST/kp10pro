...
<div id="modal-product-{{$product['id']}}-premium" class="display-none"
            ...
            <div class="row" data-gjs-type="disabled">
                ...
                <div class="col-md-6" data-gjs-type="disabled">
                    <div class="modal-product__content" data-gjs-type="disabled">
                        ...
                        <div class="kp10-discount-container" data-gjs-type="disabled">
                            <div class="modal-product__count" data-gjs-type="disabled">
                                <b data-gjs-type="disabled">Скидка: </b>  
                                <span class="kp10-discount" 
                                    data-gjs-type="discount" 
                                    data-gjs-editable="true" 
                                    data-kp10-update-prices="true">{{$product['discount']}}</span>  
